...
const routes: Routes = [
  ...
  {
    path: 'agregarlugar/:direccion/:lat/:lng', //component:AgregarlugarPage,
    loadChildren: () => import('./pages/agregarlugar/agregarlugar.module').then( m => m.AgregarlugarPageModule)
  },
];
